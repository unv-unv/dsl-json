...
abstract class WriteDescription<T> implements JsonWriter.WriteObject<T> {
	...
	public final void writeContentFull(final JsonWriter writer, final @Nullable T instance) {
		if (isEmpty) return;
	...
	public final boolean writeContentMinimal(final JsonWriter writer, final @Nullable T instance) {
